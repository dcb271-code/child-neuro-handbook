...
import type { Question, Dim1Category } from '@/lib/board-review/types';
...
export default function BoardReviewApp({ questions: allQuestions }: { questions: Question[] }) {
  ...
  const [filters, setFilters] = useState<Filters>({ dim1: 'all', population: 'all', count: 10 });
  ...
  }, [allQuestions, filters.dim1, filters.population]);
