...
export default function SectionContent({ html }: { html: string }) {
  ...
  useEffect(() => {
    ...
    // Add fullscreen buttons to spreadsheet embeds
    const spreadsheetEmbeds = container.querySelectorAll('iframe.spreadsheet-embed');
    spreadsheetEmbeds.forEach((iframe) => {
